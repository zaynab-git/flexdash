...
const demo_tabs = {
  ...
  "Websocket demo": {
    ...
    "widgets": {
      ...
      "w0018": { "kind": "Toggle", "id": "w0018",
                  "static": { "title": "input 2", "on_value":"ON", "off_value":"OFF"},
                  "dynamic": { "value": "ON" }, "output": "2", "rows": 1, "cols": 1 },
      "w0019": { "kind": "Toggle", "id": "w0019",
                  "static": { "title": "input 3", "on_value":"ON", "off_value":"OFF"},
                  "dynamic": { "value": "ON" }, "output": "3", "rows": 1, "cols": 1 },
      "w0020": { "kind": "Toggle", "id": "w0020",
                  "static": { "title": "input 4", "on_value":"ON", "off_value":"OFF"},
                  "dynamic": { "value": "ON" }, "output": "4", "rows": 1, "cols": 1 },
      "w0021": { "kind": "Toggle", "id": "w0021",
                  "static": { "title": "input 5", "on_value":"ON", "off_value":"OFF"},
                  "dynamic": { "value": "ON" }, "output": "5", "rows": 1, "cols": 1 },
      "w0022": { "kind": "Toggle", "id": "w0022",
                  "static": { "title": "input 6", "on_value":"ON", "off_value":"OFF"},
                  "dynamic": { "value": "ON" }, "output": "6", "rows": 1, "cols": 1 },
      "w0023": { "kind": "Toggle", "id": "w0023",
                  "static": { "title": "input 7", "on_value":"ON", "off_value":"OFF"},
                  "dynamic": { "value": "ON" }, "output": "7", "rows": 1, "cols": 1 },
